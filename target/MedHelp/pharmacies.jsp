    ...
    <div class="row">
        ...
        <div class="col-10 pt-4">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <h5>Table: Pharmacy</h5>
                        <h5>Overall Data Count: ${fn:length(requestScope.allPharmacy)}</h5>
                    </div>
                </div>
                ...
                <div class="row py-4">
                    ...
                    <div class="col-2">
                        <form action="goAddPharmacy" method="get">
                        ...
                        <table class="table bg-white table-striped table-bordered" id="table">
                            ...
                            <c:forEach var = "pharmacy" items="${requestScope.allPharmacy}">
                                <tr>
                                    ...
                                    <td>${pharmacy.approved}</td>
                                    <td>${pharmacy.exist}</td>
                                    <td>
                                        <form action="editPharmacy" method="get">
